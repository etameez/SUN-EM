function [] = writeFileForCpp(Const, FEKO_data, yVectors)
    ...
    if fid == -1
        ...
        fprintf(fid, '%s\t%s\t%s\t%s\t%s\t%s\t%s\n', 'V', 'V', 'V', 'CENTRE_X', 'CENTRE_Y', 'CENTRE_Z', 'AREA');
        ...
        for i = 1:FEKO_data.num_metallic_triangles
            fprintf(fid, '%d\t%d\t%d\t%f\t%f\t%f\t%f\n', FEKO_data.triangle_vertices(i, 1), ...
                                                         ...
                                                         FEKO_data.triangle_centre_point(i, 1), ...
                                                         FEKO_data.triangle_centre_point(i, 2), ...
                                                         FEKO_data.triangle_centre_point(i, 3), ...
        ...
        fprintf(fid, '%s\t%s\t%8s\t%8s\t%8s\t%8s\t%s\t%s\t%s\t%s\t%8s\t%8s\t%8s\t%8s\t%8s\t%8s\t%8s', ...
                        'V', ...
                        'V', ...
                        'CENTRE_X', ...
                        'CENTRE_Y', ...
        ...
        for i = 1:FEKO_data.num_metallic_edges
            fprintf(fid, '%d\t%d\t%8f\t%8f\t%8f\t%8f\t%d\t%d\t%d\t%d\t%8f\t%8f\t%8f\t%8f\t%8f\t%8f\n', ...
