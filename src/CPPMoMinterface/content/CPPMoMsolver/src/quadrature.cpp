...
std::vector<std::array<float, 4>> getQuadratureWeightsAndValues(int num_quadrature_points)
{
	...
	switch(num_quadrature_points)
	{
		case 6:
		{
			std::array<float, 4> point_1 = {0.223381589678011, 0.108103018168070, 0.445948490915965, 0.445948490915965};	
			std::array<float, 4> point_2 = {0.223381589678011, 0.445948490915965, 0.108103018168070, 0.445948490915965};	
			std::array<float, 4> point_3 = {0.223381589678011, 0.445948490915965, 0.445948490915965, 0.108103018168070};	
			std::array<float, 4> point_4 = {0.109951743655322, 0.816847572980459, 0.091576213509771, 0.091576213509771};	
			std::array<float, 4> point_5 = {0.109951743655322, 0.091576213509771, 0.816847572980459, 0.091576213509771};	
			std::array<float, 4> point_6 = {0.109951743655322, 0.091576213509771, 0.091576213509771, 0.816847572980459};
