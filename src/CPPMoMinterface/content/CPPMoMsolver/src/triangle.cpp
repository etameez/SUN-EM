...
Triangle::Triangle(int vertex_1, int vertex_2, int vertex_3, Node centre, double area)
{
...
double Triangle::calculateArea(Node node_vertex_1, Node node_vertex_2, Node node_vertex_3)
{
    ...
    double a = node_vertex_1.getDistanceTo(node_vertex_2);
    double b = node_vertex_1.getDistanceTo(node_vertex_3);
    double c = node_vertex_2.getDistanceTo(node_vertex_3);
...
Node Triangle::calculateCentre(Node node_vertex_1, Node node_vertex_2, Node node_vertex_3)
{
    ...
    double x_coord = (node_vertex_1.getXCoord() + 
                     node_vertex_2.getXCoord() + 
                     node_vertex_3.getXCoord()) / 3;

    double y_coord = (node_vertex_1.getYCoord() + 
                     node_vertex_2.getYCoord() + 
                     node_vertex_3.getYCoord()) / 3;

    double z_coord = (node_vertex_1.getZCoord() + 
